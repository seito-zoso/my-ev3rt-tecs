...
#   の責任を負わない．
#  
#   $Id: componentobj.rb 2633 2017-04-02 06:02:05Z okuma-top $
#++
...
#                                               ルートリージョンはドメイン名が　nil
  ...
  def new_cell( cell )
    ...
    # celltype に generate が指定されされているか(セルタイププラグイン)
    celltype_plugin = get_celltype_plugin
...
#@plugin_object:: Plugin
  ...
  def initialize( plugin_name, object_nsp, option )
    ...
    object = Namespace.find( object_nsp ) #mikan Namespace   #1
