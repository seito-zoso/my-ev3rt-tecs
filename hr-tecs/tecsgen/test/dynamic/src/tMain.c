...
eMain_main(CELLIDX idx)
{
    ...
    printf( "eMain_main: 1st call cTalker=%X\n", p_cellcb->cTalker );
    printf( "eMain_main: 1st call VMT=%X\n", p_cellcb->cTalker->VMT );
    printf( "eMain_main: 1st call hello=%X\n", p_cellcb->cTalker->VMT->hello__T );
    cTalker_hello( );
