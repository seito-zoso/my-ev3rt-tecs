/**
 *******************************************************************************
 **	ファイル名 : balancer_param-bigtire.c
 **
 **	概要       : 倒立振子制御パラメータ
 **
...
float K_F[4] = {-0.86526F, -30.73965F, -1.14828F*0.70F, -2.29757F};/* ETロボコン2018用 */
float K_I = -0.44721F;   /* サーボ制御用積分フィードバック係数 */

/* float K_PHIDOT = 25.0F*2.5F;*/ /* 車体目標旋回角速度係数 */
float K_PHIDOT = 25.0F*2.75F; /* 車体目標旋回角速度係数 (ETロボコン2018用)*/
/* float K_THETADOT = 7.5F;*/ /* モータ目標回転角速度係数 */
float K_THETADOT = 6.00F; /* モータ目標回転角速度係数 (ETロボコン2018用) */
